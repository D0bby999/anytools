...
export function SqlFormatterUi() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl">SQL Formatter</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex flex-wrap gap-3 items-end">
          <label className="text-sm">
            <span className="block mb-1 text-muted-foreground">Dialect</span>
            <select
              value={dialect}
          ...
          <label className="text-sm">
            <span className="block mb-1 text-muted-foreground">Indent</span>
            <select
              value={tabWidth}
          ...
          <label className="text-sm">
            <span className="block mb-1 text-muted-foreground">Keywords</span>
            <select
              value={keywordCase}
        ...
        <p className="text-xs text-muted-foreground">
          Formats syntax — does not execute SQL. Choose the dialect that matches your database for
          best results.
        </p>
        <PrivacyNote />
      </CardContent>
