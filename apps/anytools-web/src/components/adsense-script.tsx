...
export function AdSenseScript() {
  // Self-host builds carry no ad program of their own — the constant in adsense.ts would
  // otherwise ship the hosted site's AdSense client ID into a stranger's install.
