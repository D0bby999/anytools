...
This post is the 5-minute audit I run, the four contrast rules worth memorizing, and the tools — including a free [contrast ratio checker](/design/color-contrast) — that catch the failures before a customer files an accessibility complaint.
