...
**3.** Generate a candidate "safe" palette using a [color palette generator](/design/color-palette). Even if you don't use the output, the contrast ratios it shows for each pair are a quick sanity check against your current palette. For a deeper comparison of which generators actually verify contrast, rather than just producing nice-looking swatches, see [this breakdown of color palette tools for accessibility](/blog/color-palette-tools-for-accessibility).
...
If any of this palette also has to survive a trip to print — a PDF export of the dashboard, marketing collateral built from the same brand colors — remember hex and CMYK follow different physics. See [why print color never matches the screen](/blog/hex-to-rgb-cmyk-color-converter-print-vs-web) before you reuse these hex values on paper.
