...
No. All processing happens in your browser via the [`js-base64`](https://github.com/dankogai/js-base64) library. Open your browser's network tab — you will see zero requests while you type. The page works offline once cached.
