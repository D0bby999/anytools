...
From here, [Markdown ↔ HTML](/en/converters/md-html) will convert between the two forms again after you have edited them, [Word Counter](/en/lifestyle/word-counter) will give you a word count and reading time for the converted text, and [XLSX to CSV / JSON](/en/converters/xlsx-to-csv) does the equivalent job for an Excel workbook.
