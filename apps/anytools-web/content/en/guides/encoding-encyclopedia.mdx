...
> Try it as you read: [Base64 encoder/decoder](/encoding/base64-encode) — runs in your browser, nothing uploaded.
...
> Try it as you read: [URL encoder/decoder](/encoding/url-encode).
...
> Try it as you read: [HTML entity encoder/decoder](/encoding/html-entity).
...
> Try it as you read: [JWT decoder](/encoding/jwt-decoder) — header, payload and expiry, no key required.
...
> Try it as you read: [Unicode escape converter](/encoding/unicode-escape).
...
> Try it as you read: [Hex encoder/decoder](/encoding/hex-encode) and [Binary encoder/decoder](/encoding/binary-encode).
