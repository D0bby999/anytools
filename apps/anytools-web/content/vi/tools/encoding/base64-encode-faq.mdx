...
Không. Tất cả xử lý chạy trong trình duyệt bằng thư viện [`js-base64`](https://github.com/dankogai/js-base64). Mở tab Network — bạn sẽ thấy zero request khi gõ. Tải trang xong rồi thì bạn ngắt mạng hẳn, tool vẫn chạy bình thường.
